...
def get_args():
    ...
    parser.add_argument('--run_name', type=str, default='MambaTM_dynamic', help='Name of this run')
...
def main():
    ...
    for epoch in range(1000000):
        ...
        for data in train_loader:
            ...
            loss_all = loss + args.rt_weight * (loss_returb + 0.01 * kld) + lpips_weight * loss_lpips
            loss_all.backward()
